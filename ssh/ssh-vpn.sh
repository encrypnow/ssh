...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "${REPO}ssh/badvpn-udpgw64"
...
# install stunnel 5 
cd /root/
wget -q -O stunnel5.zip "${REPO}stunnel5/stunnel5.zip"
...
wget -q -O /etc/init.d/stunnel5 "${REPO}stunnel5/stunnel5.init"
